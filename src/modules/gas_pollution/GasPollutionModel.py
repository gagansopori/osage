...
#         self._nh3ammonia_init: float = 4956.151     # Values are subject to change
#
#         self._ads_oxidizing: float = 0.0
#         self._oxidizing_ppm: float = 0.0
#         self._oxidizing_init: float = 379143.488    # Values are subject to change
#
#         self._ads_reducing: float = 0.0
#         self._reducing_ppm: float = 0.0
#         self._reducing_init: float = 6261.529       # Values are subject to change
#
#     @property
